...
import { CheckCircle2, Circle, Trophy, Share2, Plus, Edit2, Trash2, X, MessageSquare, Save, ChevronLeft, Flame, Clock, Book } from 'lucide-react';
...
const Dashboard: React.FC<DashboardProps> = ({ goal, onBack, onToggleTask, onAddTask, onEditTask, onDeleteTask, onAddJournalEntry }) => {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 max-w-4xl mx-auto flex flex-col gap-8 animate-fade-in relative">
      ...
      {/* Quote */}
      <div className="bg-zinc-900/50 p-6 rounded-xl border-l-4 border-white italic text-zinc-300">
        ...
        <div className="flex flex-col gap-6">
          <div>
             ...
             <Visualizer 
                ...
                currentRoutineImage={goal.currentRoutineImageBase64}
             />
          </div>
